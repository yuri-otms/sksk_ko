...
class Question_Request(db.Model):
    ...
    def __init__(self, client=None, process=None, title=None, detail=None, requested_at=None, finished_at=None, read=None):
        self.client = client
    ...
    def __repr__(self):
        return '<Question_Request id:{} client:{} pricess:{} title:{} detail:{} requested_at:{} finished_at:{} read:{}'.format(self.id, self.client, self.process, self.title, self.detail, self.requested_at, self.finished_at, self.read)
